  ...
  return <section className="py-20 bg-gradient-to-br from-slate-950 via-indigo-950 to-purple-950 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          once: true
            ...
            <div className="flex items-center justify-center gap-4 mb-6">
              ...
              >
                <img
                  src={geoLogoSrc}
                  alt="Generative Search Pro GEO logo"
          ...
          <motion.div className="bg-gradient-to-r from-slate-900/80 to-slate-800/80 backdrop-blur-sm border border-slate-700/50 rounded-3xl p-12 text-center" initial={{
          opacity: 0,
          y: 40
        }} whileInView={{
          opacity: 1,
          ...
          once: true
            ...
            <div className="mb-8 bg-slate-800/50 rounded-2xl p-8 border border-slate-600/30">
              <div className="flex items-center justify-center mb-4">
                <LazyImage src="/lovable-uploads/e2c1fe64-5498-4478-b0e8-bf730de084aa.png" alt="GenerativeSearch.pro Demo" className="h-16 w-auto" displayWidth={200} displayHeight={64} />
              </div>
              ...
              <div className="w-full max-w-2xl mx-auto">
                <div className="relative aspect-[9/16] md:aspect-video rounded-xl overflow-hidden border border-slate-600/20">
                  <iframe src="https://www.youtube.com/embed/WA1WD5YHcqc?autoplay=1&mute=1&controls=0&modestbranding=1&rel=0&showinfo=0&loop=1&playlist=WA1WD5YHcqc" title="GenerativeSearch.pro Demo" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen className="absolute inset-0 w-full h-full"></iframe>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <a href="https://generativesearch.pro" target="_blank" rel="dofollow" className="group inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-bold rounded-full hover:scale-105 transform transition-all duration-300 shadow-lg hover:shadow-blue-500/25">
                <span>Launch GenerativeSearch.pro</span>
                <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform duration-300" />
              </a>
              
              <Link to="/modern-contact-form" className="inline-flex items-center px-8 py-4 border-2 border-slate-500 text-slate-300 font-semibold rounded-full hover:border-white hover:text-white transition-all duration-300">
                Get Expert Help
              </Link>
            </div>
