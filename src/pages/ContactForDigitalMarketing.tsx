  ...
  return (
    <html lang="en">
      <head>
        ...
        <title>Digital Frontier Company | Contact for Digital Marketing</title>
            ...
            <div className="bg-dark-card backdrop-blur-sm rounded-xl neon-border overflow-hidden relative z-10">
              ...
              <div className="p-8 grid-pattern">
                ...
                <div className="text-center mb-10">
                  ...
                  <p className="text-cyan-300 font-light">Contact for Digital Marketing Services</p>
                </div>
          ...
          dangerouslySetInnerHTML={{
            __html: `
              ...
              document.addEventListener('DOMContentLoaded', function() {
                ...
                // Add subtle animations to particles
