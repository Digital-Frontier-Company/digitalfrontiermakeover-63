  ...
  return (
    <>
      ...
      <div className="text-white font-sans min-h-screen relative" style={{ fontFamily: 'Inter, sans-serif' }}>
        ...
        <main className="relative z-10">
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {filteredServices.map((service, index) => (
                  <div
                    key={service.id}
                    className="service-card group relative overflow-hidden rounded-xl border border-gray-800 p-6 transition-all duration-300 hover:border-blue-500 hover:shadow-2xl hover:shadow-blue-500/25"
                    style={{
                  ...
                  >
                      ...
                      <span 
                        ...
                        style={{
                          backgroundColor: service.badge === 'AI AGENT' ? 'var(--df-bright-blue)' :
                                         service.badge === 'MARKETING' ? 'var(--df-cyan)' :
                                         service.badge === 'CONSULTING' ? '#10B981' : 'var(--df-bright-blue)',
                          color: 'white'
                        }}
                      >
                        {service.badge}
                    ...
                    <ul className="mb-6 space-y-2">
                      {service.features.map((feature, featureIndex) => (
                        <li key={featureIndex} className="flex items-center text-sm text-gray-300">
                          <i className="fa-solid fa-check mr-2 text-green-400"></i>
                          {feature}
                        </li>
                      ))}
                    </ul>
                    ...
                    <Link
                      to={service.link}
                      className="inline-flex w-full items-center justify-center rounded-lg px-4 py-3 font-medium text-white transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/25 hover:-translate-y-1"
                      style={{ backgroundColor: 'var(--df-bright-blue)' }}
                    >
                      Learn More
          ...
          <section className="px-4 md:px-12 py-16 text-center">
            <div className="max-w-4xl mx-auto">
              <h3 className="text-3xl md:text-4xl font-bold mb-6" style={{ color: 'var(--df-bright-blue)' }}>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  to="/contact"
                  className="inline-flex items-center justify-center px-8 py-4 rounded-lg font-bold text-white transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/25 hover:-translate-y-1"
                  style={{ backgroundColor: 'var(--df-bright-blue)' }}
                >
                  Get Started Today
                ...
                >
                  View Pricing
                  <i className="fa-solid fa-dollar-sign ml-2"></i>
                </Link>
              </div>
            </div>
          </section>
        ...
        {/* Footer */}
        <footer className="relative z-10 bg-gradient-to-r from-gray-900 to-black py-12">
...
export default SaaSAIAgentPackages;