      ...
      <div className="min-h-screen bg-slate-950 py-12 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ color: '#07f07f' }}>
              Digital Frontier Company
            </h1>
            <h2 className="text-2xl md:text-3xl mb-6" style={{ color: '#07e2fa' }}>
              Official Pricing Guide
            </h2>
            <p className="text-lg max-w-4xl mx-auto leading-relaxed" style={{ color: '#07f07f' }}>
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="rounded-lg p-6 border border-gray-600" 
                   style={{ background: 'linear-gradient(135deg, #1a0b4d 0%, #2d1b69 100%)' }}>
                <h4 className="text-2xl font-bold mb-2" style={{ color: '#07f07f' }}>Basic Package</h4>
                <p className="text-lg mb-4" style={{ color: '#07e2fa' }}>Your First Step into the Digital World</p>
                <div className="text-3xl font-bold mb-4" style={{ color: '#86ed07' }}>$1,500</div>
                <p className="text-sm mb-4" style={{ color: '#07f07f' }}>
                  Best For: Very small businesses and startups looking to establish a professional online presence.
                </p>
                <ul className="space-y-2 text-sm" style={{ color: '#07f07f' }}>
              ...
              <div className="rounded-lg p-6 border-2 border-yellow-400 relative" 
                   style={{ background: 'linear-gradient(135deg, #1a0b4d 0%, #2d1b69 100%)' }}>
                ...
                <h4 className="text-2xl font-bold mb-2" style={{ color: '#07f07f' }}>Professional Package</h4>
                <p className="text-lg mb-4" style={{ color: '#07e2fa' }}>Polished, Optimized, and Ready for Growth</p>
                <div className="text-3xl font-bold mb-4" style={{ color: '#86ed07' }}>$3,000</div>
                <p className="text-sm mb-4" style={{ color: '#07f07f' }}>
              ...
              <div className="rounded-lg p-6 border border-gray-600" 
                   style={{ background: 'linear-gradient(135deg, #1a0b4d 0%, #2d1b69 100%)' }}>
                <h4 className="text-2xl font-bold mb-2" style={{ color: '#07f07f' }}>Premium Package</h4>
                <p className="text-lg mb-4" style={{ color: '#07e2fa' }}>The Ultimate All-in-One Solution</p>
                <div className="text-3xl font-bold mb-4" style={{ color: '#86ed07' }}>$6,000</div>
                <p className="text-sm mb-4" style={{ color: '#07f07f' }}>
          ...
          <section className="mb-16">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="rounded-lg p-8 border border-gray-600" 
                   style={{ background: 'linear-gradient(135deg, #1a0b4d 0%, #2d1b69 100%)' }}>
                <div className="text-center mb-6">
                  <div className="text-4xl font-bold mb-4" style={{ color: '#86ed07' }}>$500/month</div>
                  <p className="text-lg" style={{ color: '#07f07f' }}>
                    Ongoing support to keep your digital presence strong and effective.
                  </p>
                </div>
                <div className="grid md:grid-cols-2 gap-6">
                  <ul className="space-y-3 text-sm" style={{ color: '#07f07f' }}>
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="rounded-lg p-6 border border-gray-600" 
                   style={{ background: 'linear-gradient(135deg, #1a0b4d 0%, #2d1b69 100%)' }}>
                <h4 className="text-xl font-bold mb-2" style={{ color: '#07f07f' }}>Advanced SEO</h4>
                <div className="text-2xl font-bold mb-2" style={{ color: '#86ed07' }}>+$1,000/month</div>
                <p className="text-sm" style={{ color: '#07f07f' }}>
              ...
              <div className="rounded-lg p-6 border border-gray-600" 
                   style={{ background: 'linear-gradient(135deg, #1a0b4d 0%, #2d1b69 100%)' }}>
                <h4 className="text-xl font-bold mb-2" style={{ color: '#07f07f' }}>Full Social Media Management</h4>
                <div className="text-2xl font-bold mb-2" style={{ color: '#86ed07' }}>+$1,500/month</div>
                <p className="text-sm" style={{ color: '#07f07f' }}>
              ...
              <div className="rounded-lg p-6 border border-gray-600" 
                   style={{ background: 'linear-gradient(135deg, #1a0b4d 0%, #2d1b69 100%)' }}>
                <h4 className="text-xl font-bold mb-2" style={{ color: '#07f07f' }}>Google Ads Management</h4>
                <div className="text-2xl font-bold mb-2" style={{ color: '#86ed07' }}>+$2,000/month</div>
                <p className="text-sm" style={{ color: '#07f07f' }}>
              ...
              <div className="rounded-lg p-6 border border-gray-600" 
                   style={{ background: 'linear-gradient(135deg, #1a0b4d 0%, #2d1b69 100%)' }}>
                <h4 className="text-xl font-bold mb-2" style={{ color: '#07f07f' }}>Conversion Rate Optimization</h4>
                <div className="text-2xl font-bold mb-2" style={{ color: '#86ed07' }}>+$1,000/month</div>
                <p className="text-sm" style={{ color: '#07f07f' }}>
              ...
              <div className="rounded-lg p-6 border border-gray-600" 
                   style={{ background: 'linear-gradient(135deg, #1a0b4d 0%, #2d1b69 100%)' }}>
                <h4 className="text-xl font-bold mb-2" style={{ color: '#07f07f' }}>CRM Setup & Automation</h4>
                <div className="text-2xl font-bold mb-2" style={{ color: '#86ed07' }}>$3,000 (one-time)</div>
                <p className="text-sm" style={{ color: '#07f07f' }}>
              ...
              <div className="rounded-lg p-6 border border-gray-600" 
                   style={{ background: 'linear-gradient(135deg, #1a0b4d 0%, #2d1b69 100%)' }}>
                <h4 className="text-xl font-bold mb-2" style={{ color: '#07f07f' }}>Analytics & Reporting</h4>
                <div className="text-2xl font-bold mb-2" style={{ color: '#86ed07' }}>+$750/month</div>
                <p className="text-sm" style={{ color: '#07f07f' }}>
