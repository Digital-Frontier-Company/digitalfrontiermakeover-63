        ...
        zIndex: 10
          ...
          <div className="max-w-4xl mx-auto px-6">
            <div className="backdrop-blur-sm border border-white/20 rounded-2xl p-8 md:p-12 bg-white/10 px-[33px] py-[66px] mx-0 my-[13px]">
              {/* Main Headlines */}
              <h1 className="text-4xl mb-6 leading-tight bg-gradient-to-r from-cyan-400 via-white to-yellow-300 bg-clip-text text-transparent font-extrabold md:text-7xl" style={{ textShadow: '0 0 20px #1a237e, 0 0 40px #1a237e, 0 0 60px #1a237e, 0 0 80px #1a237e', WebkitTextStroke: '1px black' }}>
